...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-user-2"></span>编辑{{Config::get('application.support_language')[$language]}}文版本</span>
        <div class="clear"></div>
    </div>
    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="{{ URL::to('product/language/edit?language='.$language.'&product_id='.$product->product_id) }}" title="">编辑{{Config::get('application.support_language')[$language]}}文版本</a></li>
            </ul>
        </div>
    ...
    <div class="wrapper">
        ...
        <form action="{{ URL::to('product/language/update') }}" method="POST" class="main">
            <fieldset>
                ...
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid5">{{$product_cn->name}}</div>
                        <div class="clear"></div>
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid5"><input type="text" name="keywords" value="{{$product->keywords}}"/><label>用英文","分隔</label/></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid1"><label style="float: right">简要描述：</label></div>
                        <div class="grid5"><textarea name="short_description">{{$product->short_description}}</textarea></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid1"><lable style="float: right">详细描述：</label></div>
                        <div class="grid11">
                            {{$product_cn->description}}
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
