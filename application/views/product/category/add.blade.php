...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-user-2"></span>添加代理</span>
        <div class="clear"></div>
    </div>
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" name="company" style="width: 14.89361702%"/></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                        <div class="grid3"><label>电话：</label></div>
                        <div class="grid9"><input type="text" name="phone" style="width: 14.89361702%"/></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" name="address" style="width: 20.89361702%"/></div>
                        <div class="clear"></div>
                    </div>
