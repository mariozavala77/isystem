...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-user-2"></span>添加{{ $channel['cn'] }}渠道</span>
        <div class="clear"></div>
    </div>
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" name="accredit['Server']" style="width: 50%" required="true" value="https://mws.amazonservices.com/"/></div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow">
