...
class Transport
{
     ...
     * @param   mix         $params         查询参数，形如bar=foo&foo=bar；或者是一维关联数组
     * @param   string      $method         请求方式，是POST还是GET
     * @param   array       $my_header      用户要发送的头部信息，为一维关联数组
     * @return  array                       成功返回一维关联数组，形如['header'=>'bar', 'body'=>'foo']*                                      重大错误程序直接停止运行，否则返回false。
     */
