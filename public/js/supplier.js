 $(function(){
    $('#supplier_delete_confirm').dialog({
        ...
        buttons: {
            "删除": function () {
                $(this).dialog("close");
                $.post('/supplier/delete',{channel_id:del_id},function(response){
    ...
    aTable = $('#supplier_list_table').dataTable({
                        ...
                        fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                            var id = aData[5];
                            var operation = '<a href="/supplier/edit?supplier_id=' + id + '" class="tablectrl_small bDefault tipS" original-title="编辑"><span class="iconb" data-icon=""></span></a>' + 
